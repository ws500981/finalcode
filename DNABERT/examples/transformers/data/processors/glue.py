...
class SequencePredictionProcessor(DataProcessor):
    ...
    def get_letter(self, no_letter, n, i, label):
        ...
        if i == 0:
            for p in range(0,4):
                label0 = label
                label0 = self.get_letter(no_letter, n-1, p, label0 + "A")
            return label
        elif i == 1:
            for p in range(0,4):
                label1 = label
                label1 = self.get_letter(no_letter, n-1, p, label1 + "T")
            return label
        elif i == 2:
            for p in range(0,4):
                label2 = label
                label2 = self.get_letter(no_letter, n-1, p, label2 + "C")
            return label
        elif i == 3:
            for p in range(0,4):
                label3 = label
                label3 = self.get_letter(no_letter, n-1, p, label3 + "G")
            return label
